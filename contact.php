...
<html lang="en">
  ...
  ?>
    ...
    <main class="max-w-3xl mx-auto px-6 py-12">
      ...
      <p class="text-gray-700 mb-6">For commissions, collaborations, or press inquiries, drop a message below or email me at <a href="mailto:ama@example.com" class="underline">ama@example.com</a>.</p>
